...
class Ui_Preferences(object):
    def setupUi(self, Preferences):
        ...
        self.pref_lang.setGeometry(QtCore.QRect(170, 110, 211, 21))
        ...
        self.pref_title.setGeometry(QtCore.QRect(6, 7, 241, 21))
        font = QtGui.QFont()
        ...
        self.pref_statistics.setGeometry(QtCore.QRect(170, 140, 211, 21))
        ...
        self.pref_buttons.setGeometry(QtCore.QRect(10, 336, 381, 23))
        ...
        self.line_2.setGeometry(QtCore.QRect(5, 316, 388, 16))
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.label_6 = QtWidgets.QLabel(Preferences)
        self.label_6.setGeometry(QtCore.QRect(16, 230, 141, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.pref_zana_level.setGeometry(QtCore.QRect(170, 230, 41, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_7.setGeometry(QtCore.QRect(16, 260, 141, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.pref_defualt_zana_mod.setGeometry(QtCore.QRect(170, 260, 211, 23))
        ...
        self.pref_on_top.setGeometry(QtCore.QRect(90, 290, 221, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_9.setGeometry(QtCore.QRect(16, 200, 141, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_9.setFont(font)
        self.label_9.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_9.setObjectName("label_9")
        self.pref_defualt_league = QtWidgets.QComboBox(Preferences)
        self.pref_defualt_league.setGeometry(QtCore.QRect(170, 200, 211, 23))
        self.pref_defualt_league.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pref_defualt_league.setCurrentText("")
        self.pref_defualt_league.setMaxVisibleItems(10)
        self.pref_defualt_league.setObjectName("pref_defualt_league")
    ...
    def retranslateUi(self, Preferences):
        ...
        self.label_9.setToolTip(_translate("Preferences", "<html><head/><body><p><span style=\" font-size:8pt;\">The level of your Master Zana will affect which mods you can use and how much bonus IQ you get from the first mod. </span></p></body></html>"))
        self.label_9.setText(_translate("Preferences", "Defualt League:"))
