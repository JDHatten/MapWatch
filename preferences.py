...
class Ui_Preferences(object):
    ...
    def retranslateUi(self, Preferences):
        ...
        self.pref_map_check.setToolTip(_translate("Preferences", "<html><head/><body><p><span style=\" font-size:8pt;\">The amount of second\'s in-between clipboard checks this application preforms. </span></p></body></html>"))
